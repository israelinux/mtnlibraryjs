(function(){var global=this;if(typeof Mtn==='undefined'){global.Mtn={};}
...
return lel;else
return Mtn.utils.createId(el);};Mtn.id=Mtn.utils.createId;Mtn.support={};var fi=document.createElement('input');fi.type='file';if(fi.multiple===false||fi.multiple===true){fi.multiple=true;}
...
return null;};Mtn.anyMtn=function(array,query){var fn=Mtn.lambda(query);for(var i=0;i<array.length;i++){if(fn(array[i])){return true;}}
return false;};Mtn.version=function(password){Mtn.Library.Internals.Utilities.version({data:{password:password},success:function(r){console.log(r);},error:function(){console.log(arguments);}});};})();